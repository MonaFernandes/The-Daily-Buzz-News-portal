...
<footer class="footer">
  ...
  <a href="./index.php" style="color: red; text-decoration: none;">THE DAILY BUZZ</a>
    <p>
      The collection point of world news. A one stop shop. We bring to you the current happenings around the world from
      esteemed writers. Make sure to read up and keep up with us through this platform that we bring to you. The Daily Buzz.
    </p>
    <div class="socials">
  ...
  <ul class="footer-right">
    ...
    <li>
      ...
      <ul class="box">
        <li>
          Share the story in your own words with the world. To Inspire with your writing make The Daily Buzz your platform to
  ...
  <div class="footer-bottom">
    <p>All Rights Reserved by &copy; The Daily Buzz <?php echo date("Y")?></p>
  </div>
</footer>

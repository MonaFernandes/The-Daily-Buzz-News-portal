...
function createArticleCard($title, $img, $data, $category, $cat_id, $id, $color, $new, $trend, $marked, $videos){
  echo '
  <article class="card">
    <a href="';
  ...
  if (!empty($videos)) {
      ...
      foreach ($videoUrls as $videoUrl) {
          echo '<p><a href="'.$videoUrl.'" target="_blank">'.$videoUrl.'</a></p>';
      }
      echo '</div>';
  }

  echo '<a href="news.php?id='.$id.'" class="btn btn-card">Read More <span>&twoheadrightarrow; </span>
      </a>
    </div>
  </article>';
}
...
// Function to create an Aside Card

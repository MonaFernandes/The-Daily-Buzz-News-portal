...
<head>
  ...
  <!-- TITLE OF THE PAGE -->
  <title>The Daily Buzz | The Official News Portal | <?php echo $page_title; ?></title>
...
<body>
  ...
  <!-- ======== NAVBAR ======== -->
  <nav class="navbar">
    <div class="logo"><a href="./index.php"><img src="./assets/images/LOGO3.png" style="width:300px;"/></a></div>

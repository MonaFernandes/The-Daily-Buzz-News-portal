<?php
  ...
  if (isset($_POST['submit'])) { 
    ...
    $article_cat_id = mysqli_real_escape_string($con, $_POST['category_id']);
    $video_link = mysqli_real_escape_string($con, $_POST['video_link']); // Added for video link
    
    // Generate file name for article image
    ...
    // Current date for article
    $article_date = date("Y-m-d");
    
    // SQL query to insert article into database
    $sql = "INSERT INTO article 
            (category_id, author_id, article_title, article_image, article_description, article_date, article_trend, article_active, article_videos) 
            VALUES 
            ('$article_cat_id', '$author_id', '$article_title', '$basename', '$article_desc', '$article_date', 0, 0, '$video_link')";
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form method="post" id="add_form" enctype="multipart/form-data">
              ...
              <br>
              <div class="form-group text-center">
                <label for="video_link">Article video URL:</label>
